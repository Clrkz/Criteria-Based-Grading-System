<?php
    ...
    $r2 = mysql_query('select count(*) from subject where status = 1');
    $count2 = mysql_fetch_array($r2);

    $r3 = mysql_query('select count(*) from teacher where status = 1');
    $count3 = mysql_fetch_array($r3);

    $r4 = mysql_query('SELECT count(*) FROM `class` WHERE `status` = 1');
