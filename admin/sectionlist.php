            ...
            <div class="col-lg-12">
                <?php if(isset($_GET['r'])): ?>
                    ...
                    <div class="alert alert-<?php echo $class?> <?php echo $classs; ?>">
                        <strong>Section successfully <?php echo $r; ?>!</strong>    
                    </div>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <?php while($row = mysql_fetch_array($section)): ?>                            
                                <tr>
                                    ...
                                    <td class="text-center">
									 <a href="edit.php?type=section&id=<?php echo $row['id']?>" title="Update Section"><i class="fa fa-edit fa-2x text-primary"></i></a>
                                 
                                       <a href="data/section_model.php?q=deletesection&id=<?php echo $row['id']?>" title="Remove"><i class="fa fa-times-circle fa-2x text-danger confirmation"></i></a></td>
                                </tr>
                            <?php $c++; ?>
                            <?php endwhile; ?>
