                        ...
                        <tbody>
                            ...
                            <?php while($row = mysql_fetch_array($class)): ?>                            
                                <tr>
                                    ...
                                    <td class="text-center"><a href="classteacher.php?classid=<?php echo $row['id'];?>&teacherid=<?php if($row['teacher'] == ''){echo '0';}else{ echo $row['teacher']; };?>" title="update teacher">View</a></td>
                                    <td class="text-center"><a href="classstudent1.php?classid=<?php echo $row['id'];?>&id=<?php if($row['teacher'] == ''){echo '0';}else{ echo $row['teacher']; };?>" title="update students" title="add student">View</a></td>
