        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="classstudent1.php?classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" method="post">
                        ...
                        <button type="submit" name="submitsearch" class="btn btn-success"><i class="fa fa-search"></i> Search</button>  
						 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addstudent1"><i class="fa fa-user"></i> Add Student</button>
                        <a href="classstudent1.php?classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="btn btn-primary">Master List</a>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/class_model.php?q=addstudent1&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="btn btn-warning">Add to class</a></td>     
                                </tr>
                                <?php endwhile;?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['fname']; ?></td>
                                    <td><?php echo $row['lname']; ?></td>
                                    <td class="text-center"><a href="data/class_model.php?q=removestudent1&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="confirmation"><i class="fa fa-times-circle fa-2x text-danger"></i></a></td>     
                                </tr>
                                <?php endforeach;?>
