                            ...
                            <?php while($row = mysql_fetch_array($subject)): ?>                            
                                <tr>
                                    ...
                                    <td class="text-center">
									 <a href="edit.php?type=subject&id=<?php echo $row['id']?>" title="Update Subject"><i class="fa fa-edit fa-2x text-primary"></i></a>
                                 
									<a href="data/data_model.php?q=deletesubject&id=<?php echo $row['id']?>"><i class="fa fa-times-circle fa-2x text-danger confirmation"></i></a></td>
                                </tr>
                            <?php $c++; ?>
                            <?php endwhile; ?>
