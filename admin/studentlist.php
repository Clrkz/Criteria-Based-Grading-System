        ...
        <div class="row">
			...
			<div class="col-lg-12">
                <?php if(isset($_GET['m'])): ?>
                    ...
                    ?>
                    <div class="alert alert-<?php echo $class?> <?php echo $classs; ?>">
                        <strong>Student ID already <?php echo $r; ?>!</strong>    
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
-->									 <a href="studentsubject.php?id=<?php echo $row['id'];?>" title="View Subject"><i class="fa fa-bar-chart-o fa-2x text-success"></i></a> &nbsp;
                                     <a href="edit.php?type=student&id=<?php echo $row['id']?>" title="update student"><i class="fa fa-edit fa-2x text-primary"></i></a>
