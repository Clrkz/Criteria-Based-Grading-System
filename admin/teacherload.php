        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
<?php
    $r1 = mysql_query("select * from class where teacher=$id and status = 1");
    while($row = mysql_fetch_array($r1)):?>
            <tr>
                <td class="text-center"><?php echo $row['subject']?></td>            
                <td class="text-center"><a href="classstudent.php?classid=<?php echo $row['id']?>&id=<?php echo $id; ?>" target="">View</a></td>     
