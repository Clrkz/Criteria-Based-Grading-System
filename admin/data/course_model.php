<?php
    ...
    class Datacourse {
        ...
        function getcourse($search){
            $q = "select * from course where status =1 and name like '%$search%'  order by name";
            $r = mysql_query($q);
        ...
        function addcourse(){
            ...
            $q = "INSERT INTO `course`(`name`,`status`) VALUES ('$name',1)";
            mysql_query($q);
        ...
        function updatecourse(){
		 ...
		 function deletecourse(){
            include('../../config.php');
            $id = $_GET['id']; 
            $q = "update course set status=0 where id=$id";
            mysql_query($q);
