        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="teacherload.php?id=<?php echo $teacherid; ?>">Teacher's Load</a>
                    </li>
                    <li class="active">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="classstudent.php?classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" method="post">
                        ...
                        <a href="classstudent.php?classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="btn btn-primary">Master List</a>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/class_model.php?q=addstudent&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="btn btn-warning">Add to class</a></td>     
                                </tr>
                                <?php endwhile;?>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row['fname']; ?></td>
                                    <td><?php echo $row['lname']; ?></td>
                                    <td class="text-center"><a href="data/class_model.php?q=removestudent&studid=<?php echo $row['id']; ?>&classid=<?php echo $classid;?>&id=<?php echo $teacherid;?>" class="confirmation"><i class="fa fa-times-circle fa-2x text-danger"></i></a></td>     
                                </tr>
                                <?php endforeach;?>
