<?php
    ...
    $mystudent = $student->getexambyclass($classid); 
?>
<div id="page-wrapper">
            ...
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="student.php?classid=<?php echo $classid?>" method="post">
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addexam" ><i   ></i> Add Exam</button>
					  ...
					  <?php while($row = mysql_fetch_array($mystudent)): ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo $row['total']; ?></td>  
                             ...
                             <td class="text-center"> <a href="examclass.php?id=<?php echo $row['id']?>&classid=<?php echo $classid;?>&criterianame=<?php echo $row['name']; ?>" class="btn btn-primary">Students</a> </td>    
							<td class="text-center">                                                                               
                                        <a href="edit.php?type=exam&id=<?php echo $row['id']?>&classid=<?php echo  $classid; ?>" title="update exam"><i class="fa fa-edit fa-2x text-primary"></i></a>
                                        <a href="data/data_model.php?q=deleteGlobal&table=exam&id=<?php echo $row['id']?>&classid=<?php echo  $classid; ?>" title="delete exam"><i class="fa fa-times-circle fa-2x text-danger confirmation"></i></a>
										</td>
