<?php
    ...
    $subject = $data->getsubject($search,$id);
?>
<div id="page-wrapper">
            ...
            <div class="col-lg-12">
                <div class="form-inline form-padding">
                    <form action="subjectlist.php" method="post">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addsubject">Add Subject</button>
                    </form>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php while($row = mysql_fetch_array($subject)): ?>                            
                                <tr>
                                    ...
                                    <td class="text-center"><a href="data/data_model.php?q=deletesubject&id=<?php echo $row['id']?>"><i class="fa fa-times-circle fa-lg text-danger confirmation"></i></a></td>
                                </tr>
                            <?php $c++; ?>
                            <?php endwhile; ?>
