            ...
            <div class="col-lg-12">
                <?php if(isset($_GET['r'])): ?>
                    ...
                    <div class="alert alert-<?php echo $class?> <?php echo $classs; ?>">
                        <strong>1 course successfully <?php echo $r; ?>!</strong>    
                    </div>
                <?php endif; ?>
            </div>
        </div>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <?php while($row = mysql_fetch_array($course)): ?>                            
                                <tr>
                                    <td><?php echo $c;?></td>
                                    <td><a href="edit.php?type=course&id=<?php echo $row['id']?>"><?php echo $row['name'];?></a></td> 
                                    <td class="text-center">
                                       <a href="data/data_model.php?q=delete&table=course&id=<?php echo $row['id']?>" title="Remove"><i class="fa fa-times-circle fa-2x text-danger confirmation"></i></a></td>
                                </tr>
                            <?php $c++; ?>
                            <?php endwhile; ?>
